...
open class TextFieldEffects : UITextField {
    ...
    */
    ...
    override open func willMove(toSuperview newSuperview: UIView!) {
        if newSuperview != nil {
//            NotificationCenter.default.addObserver(self, selector: #selector(textFieldDidEndEditing), name: UITextField.NSNotification.Name.UITextFieldTextDidEndEditing, object: self)
//            
//            NotificationCenter.default.addObserver(self, selector: #selector(textFieldDidBeginEditing), name: UITextField.NSNotification.Name.UITextFieldTextDidBeginEditing, object: self)
        } else {
